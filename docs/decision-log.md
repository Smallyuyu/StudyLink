...
| --- | --- | --- | --- |
| 2026-05-31 | Use Spring Boot 3 with Java 21 | Matches the project brief and gives a conventional MVC/JPA/Security stack for a Java web MVP. | Less lightweight than a tiny servlet app, but much faster to build and test safely. |
